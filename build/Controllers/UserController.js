...
exports.topKUser = exports.getAllUser = exports.getUser = exports.updateUser = exports.createUser = void 0;
...
var topKUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var getPosts, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                console.log("----");
                return [4 /*yield*/, Post_1.default.aggregate([
                        {
                            $lookup: {
                                from: "user",
                                localField: "_id",
